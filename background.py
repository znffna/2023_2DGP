...
class FixedBackground:
    ...
    def update(self):
        ...
        self.window_left = clamp(0, self.window_left, self.w - self.cw - 1)  # 이미지의 너비 - 캔버스의 너비 - 1
        self.window_bottom = clamp(0, self.window_bottom, self.h - self.ch - 1)  # 이미지의 높이 - 캔버스의 높이 - 1
        pass
